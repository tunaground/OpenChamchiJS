...
export const updateSettingsSchema = z.object({
  ...
  storageProvider: z.enum(["supabase", "s3"]).optional().nullable(),
  ...
  s3Region: z.string().max(30).optional().nullable(),
  s3Endpoint: z.string().url().max(200).optional().nullable(),
  s3AccessKeyId: z.string().max(200).optional().nullable(),
  s3SecretAccessKey: z.string().max(500).optional().nullable(),
  s3Bucket: z.string().max(100).optional().nullable(),
  s3PublicUrl: z.string().url().max(200).optional().nullable(),
